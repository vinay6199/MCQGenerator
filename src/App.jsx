...
// (You can extend this easily — clean structure, simple to edit)
const QUESTIONS = {
  Physics: {
    6: [
    ...
    8: [
      { q: "Which mirror forms virtual images?", options: ["Concave", "Convex", "Plane", "Both convex and plane"], answer: "Both convex and plane" },
    ],
    9: [
      { q: "Unit of current?", options: ["Ampere", "Volt", "Joule", "Watt"], answer: "Ampere" },
    ],
    10: [
  ...
  Chemistry: {
    6: [
      { q: "Water formula?", options: ["H₂O", "O₂", "CO₂", "NaCl"], answer: "H₂O" },
      { q: "Salt contains?", options: ["Na & Cl", "H & O", "C & N", "K & Br"], answer: "Na & Cl" },
    ],
    7: [
      { q: "pH of water?", options: ["7", "0", "14", "1"], answer: "7" },
    ],
    8: [
      { q: "Acid turns blue litmus?", options: ["Red", "Blue", "Green", "No change"], answer: "Red" },
    ],
  },
  ...
  Maths: {
    ...
    10: [
      { q: "Derivative of x²?", options: ["2x", "x", "x³", "1"], answer: "2x" },
    ],
  },
  ...
  Biology: {
    ...
    7: [
      { q: "Plants prepare food by?", options: ["Photosynthesis", "Respiration", "Digestion", "Excretion"], answer: "Photosynthesis" },
    ],
    10: [
      { q: "Mitosis produces how many cells?", options: ["2", "4", "6", "8"], answer: "2" },
    ],
  },
};
...
export default function App() {
  ...
  const generate = () => {
    ...
    const pool = QUESTIONS[subject][standard];
    ...
    <div className="w-full min-h-screen bg-gray-100 p-6 flex flex-col items-center">
      ...
      <div className="bg-white shadow-md p-5 rounded w-full max-w-3xl mb-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input type="number" className="w-full p-2 border rounded" value={count} onChange={(e) => setCount(e.target.value)} />
        </div>
      </div>
